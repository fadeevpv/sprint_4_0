...
from PageObjects import Question_Block
...
class TestProgram:
    ...
    def test_first_question(self, browser):
        first_question = Question_Block(browser)  # Создаем экземпляр класса first_question
        first_question.go_to_site()  # Запускаем сайт
        browser.execute_script(
            "window.scrollTo(0, document.body.scrollHeight);")  # Создаем скрипт
        first_question.check_first_question()  # Запускаем первый метод на проверку
    ...
    def test_second_question(self, browser):
        second_question = Question_Block(browser)
    ...
    def test_third_question(self, browser):
        third_question = Question_Block(browser)
        third_question.check_third_question()
    ...
    def test_fourth_question(self, browser):
        fourth_question = Question_Block(browser)
        fourth_question.check_fourth_question()
    ...
    def test_fifth_question(self, browser):
        fifth_question = Question_Block(browser)
        fifth_question.check_fifth_question()
    ...
    def test_sixth_question(self, browser):
        sixth_question = Question_Block(browser)
        sixth_question.check_sixth_question()
    ...
    def test_seventh_question(self, browser):
        seventh_question = Question_Block(browser)
        seventh_question.check_seventh_question()
    ...
    def test_eighth_question(self, browser):
        eighth_question = Question_Block(browser)
        eighth_question.check_eighth_question()
